        ...
        <div className="w-full max-w-md p-8 space-y-8 bg-white/10 backdrop-blur-md shadow-2xl rounded-2xl border border-white/20">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
            <div className="space-y-4 rounded-md">
              <div>
                <label className="block text-sm font-medium text-slate-200 mb-1" htmlFor="email">Email</label>
                <input
                  id="email"
                  type="email"
                  value={username}
          ...
          <div className="text-center text-sm text-slate-200">
            New user?{" "}
            <Link to="/signup" className="font-medium text-blue-300 hover:text-blue-100 underline">
              Sign Up
            </Link>
          </div>
        </div>
